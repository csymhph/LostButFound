...
class SliceData(Dataset):
    def __init__(self, root1, root2=0, transform, input_key, target_key, forward=False):
...
def create_data_loaders(data_path_1, data_path_2, int path2_ind = 0, args, shuffle=True, isforward=False):
    if isforward == False:
